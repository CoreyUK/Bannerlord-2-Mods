...
internal static class StrategicAiTuning
{
    ...
    /// <summary>Abandon a siege when our local power falls below this fraction of the relief force.</summary>
    public static float RetreatPowerRatio = 0.8f;
    ...
    /// </summary>
    public static bool EnableGarrisonReinforcement = false;
    ...
    /// </summary>
    public static bool EnableSiegeRetreat = false;
    ...
    /// </summary>
    public static bool EnableWeatherEffects = false;
